...
let motionBuffer = new CircularBuffer(100 * 2 * 3);
...
function handleResults(error, results) {
    ...
    document.getElementById('classifyData').innerHTML = `label:${results[0].label}, confidence: ${results[0].confidence.toFixed(2)}`;
...
function onAccelerometerValueChanged(event) {
    ...
    let normalizedAx = normalize(accelerationX, 2040, -2040);
    let normalizedAy = normalize(accelerationY, 2040, -2040);
    let normalizedAz = normalize(accelerationZ, 2040, -2040);
